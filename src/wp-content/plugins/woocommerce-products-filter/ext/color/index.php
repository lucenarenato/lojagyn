        ...
        if (!empty($terms)) {
            ...
            <ul class="woof_color_list woof_hide_options">
                ...
                foreach ($terms as $t) {
                    ...
                    $color = '';
                    if (isset($woof_settings['color'][$key][$t['slug']]) && $woof_settings['color'][$key][$t['slug']] != '') {
                        $color = $woof_settings['color'][$key][$t['slug']];
                    } else {
                        $color = get_term_meta( $t['term_id'], 'product_attribute_color', true );
                    }
                    ...
                    if (isset($woof_settings['color_img'][$key][$t['slug']])) {
                        ...
                        $color_img = get_term_meta( $t['term_id'], 'product_attribute_image', true );
                        if (!empty($color_img)) {
                            $color_img = wp_get_attachment_image_url($color_img);
                        }
                    }
                    ?>
                    <li>
