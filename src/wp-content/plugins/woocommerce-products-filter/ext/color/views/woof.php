...
<ul class = "woof_list woof_list_color <?php echo $show_title_class ?>" data-type="<?php echo $color_type ?>">
    <?php
...
//excluding hidden terms
    ...
    <?php if (!empty($terms)): ?>
        <?php foreach ($terms as $term) : $inique_id = uniqid(); ?>
            ...
            // ET: Color/Image swatches
            $color = '#ffffff';
            if (isset($colors[$term['slug']]) && $colors[$term['slug']] != "") {
