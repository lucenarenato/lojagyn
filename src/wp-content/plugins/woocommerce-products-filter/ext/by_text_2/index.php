...
final class WOOF_EXT_BY_TEXT_2 extends WOOF_EXT {
    ...
    public function get_js() {
        ...
        <?php if (isset($WOOF->settings['by_text_2']['autocomplete'])): ?>
            woof_text_autocomplete =<?php echo (int) $WOOF->settings['by_text_2']['autocomplete']; ?>;
        ...
        <?php if (isset($WOOF->settings['by_text_2']['post_links_in_autocomplete'])): ?>
            woof_post_links_in_autocomplete =<?php echo (int) $WOOF->settings['by_text_2']['post_links_in_autocomplete']; ?>;
        <?php endif; ?>

        var how_to_open_links = 0;
        <?php if (isset($WOOF->settings['by_text_2']['how_to_open_links'])): ?>
            how_to_open_links =<?php echo (int) $WOOF->settings['by_text_2']['how_to_open_links']; ?>;
            <?php
        endif;
        return ob_get_clean();
    }
    ...
    public function get_style() {
        ...
        if (isset($WOOF->settings['by_text_2']['image'])) {
            if (!empty($WOOF->settings['by_text_2']['image'])) {
                ...
                background: url(<?php echo $WOOF->settings['by_text_2']['image'] ?>) !important;
                }
                <?php
            }
        }
