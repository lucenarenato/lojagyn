...
if (!function_exists('woof_draw_select_childs_h')) {
    ...
    function woof_draw_select_childs_h(&$collector, $selected_chain, $parent_data, $show_chain_always) {
        ...
        if (empty($parent_data['childs']) AND $show_chain_always) {
            ...
            <label class="woof_wcga_label_hide"  for="<?php echo $select_id ?>"><?php echo WOOF_HELPER::wpml_translate($taxonomy_info, '', 0) ?> <?php echo $level ?></label>			
            <select id="<?php echo $select_id ?>" class="woof_select woof_select_<?php echo $tax_slug ?> woof_select_<?php echo $tax_slug ?>_<?php echo $level ?>" name="<?php echo $tax_slug ?>" disabled="">
            ...
            <?php if (!empty($childs)): ?>
                <?php $select_id = 'woof_hh_slider_' . $tax_slug . $level; ?>
                <label class="woof_wcga_label_hide"  for="<?php echo $select_id ?>"><?php echo WOOF_HELPER::wpml_translate($taxonomy_info, '', 0) ?> <?php echo $level ?></label>
                <select id="<?php echo $select_id ?>" class="woof_select woof_select_<?php echo $tax_slug ?> woof_select_<?php echo $tax_slug ?>_<?php echo $level ?>" name="<?php echo $tax_slug ?>">
                    <option value="0"><?php echo WOOF_HELPER::wpml_translate($taxonomy_info, '', $level) ?></option>
...
?>
<label class="woof_wcga_label_hide"  for="<?php echo $select_id ?>"><?php echo WOOF_HELPER::wpml_translate($taxonomy_info, '', 0) ?></label>
<select id="<?php echo $select_id ?>" <?php if ($really_current_term_id > 0 AND array_key_exists($really_current_term_id, $terms)): ?>disabled=""<?php endif; ?> class="woof_select woof_select_<?php echo $tax_slug ?> woof_select_<?php echo $tax_slug ?>_0" name="<?php echo $tax_slug ?>">
