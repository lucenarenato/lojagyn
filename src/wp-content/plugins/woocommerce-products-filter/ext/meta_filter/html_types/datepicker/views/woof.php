            ...
            <div class="woof_container_inner woof_container_inner_datepicker_slider">
                ...
                <div class="<?php echo $css_classes ?>">
                    <div class="woof_meta_datepicker_container">
						...
						<input id="<?php echo $date_id ?>_from" data-format="<?php echo $format ?>" type="text" readonly="readonly" data-meta-key="<?php echo $meta_key ?>" class="woof_calendar woof_calendar_from" placeholder="<?php esc_html_e('from', 'woocommerce-products-filter') ?>" />
                        <label class="woof_wcga_label_hide"  for="<?php echo $date_id ?>_from"><?php esc_html_e("From", 'woocommerce-products-filter') ?></label>
                    ...
                    <div class="woof_meta_datepicker_container">
                        ...
                        <input id="<?php echo $date_id ?>_to" data-format="<?php echo $format ?>" type="text" readonly="readonly" data-meta-key="<?php echo $meta_key ?>" class="woof_calendar woof_calendar_to" placeholder="<?php esc_html_e('to', 'woocommerce-products-filter') ?>" />
                        <label class="woof_wcga_label_hide"  for="<?php echo $date_id ?>_to"><?php esc_html_e("To", 'woocommerce-products-filter') ?></label>
