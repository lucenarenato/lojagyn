        ...
        if ($extended_filter) {
            if ($price_filter == 1) {
                ...
                <div class="woof_qt_add_filter ">
                    <input class="woof_qt_price_slider" data-skin="<?php echo $skin ?>"  data-min="<?php echo $min ?>" data-max="<?php echo $max ?>" data-min-now="<?php echo $min_price ?>" data-max-now="<?php echo $max_price ?>" data-step="<?php echo $slider_step ?>" data-slider-prefix="<?php echo $slider_prefix ?>" data-slider-postfix="<?php echo $slider_postfix ?>" value="" />
                </div>
                <?php
            }
            if ($add_filters !== '') {
                            ...
                            <div class="woof_qt_add_filter woof_qt_add_filter_checkbox woof_qt_add_filter_checkbox_<?php echo $filter_struct[1] ?>">
                                ...
                                foreach ($terms as $term) {
                                    ...
                                    <div class="woof_qt_item_container">
                                        <input type="checkbox" id="term_<?php echo $unique_id ?>" name="woof_qt_check_<?php echo $filter_struct[1] ?>" class="woof_qt_checkbox tax_<?php echo $filter_struct[1] ?>" data-tax="<?php echo $filter_struct[1] ?>"value="<?php echo $term->term_id ?>" >
                                        <label class="woof_qt_checkbox_label" for="term_<?php echo $unique_id ?>"><?php echo $term->name ?></label>
                                    </div>
                                    <?php
                                }
                                ?>
            ...
            case'slider':
                if ($meta_item['search_view'] != 'slider') {
                    ?> <div class="woof_qt_add_filter "><p class="woof_notice"><a href="#"><?php esc_html_e('Error! Please read documents', 'woocommerce-products-filter'); ?></a></p></div><?php
                        ...
                        ?>
                <div class="woof_qt_add_filter ">
                    <input class="woof_qt_meta_slider" data-skin="<?php echo $skin ?>" data-tax="<?php echo$meta_item['meta_key'] ?>"  data-min="<?php echo $min ?>" data-max="<?php echo $max ?>" data-step="<?php echo $meta_settings['step'] ?>" data-slider-prefix="<?php echo $meta_settings['prefix'] ?>" data-slider-postfix="<?php echo $meta_settings['postfix'] ?>" value="" />
                </div>
                <?php
                break;
            default :
