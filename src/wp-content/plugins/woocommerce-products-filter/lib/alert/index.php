...
add_action('init', function() {
    ...
    add_action('admin_notices', function() use($slug) {
        ...
        <div class="notice notice-info" id="pn_<?php echo $slug ?>_ask_favour" style="position: relative;">
            <button onclick="javascript: return pn_<?php echo $slug ?>_dismiss_review(1); void(0);" title="<?php esc_html_e('Later', 'woocommerce-products-filter'); ?>" class="notice-dismiss"></button>
