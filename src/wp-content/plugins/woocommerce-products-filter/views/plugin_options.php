...
<div class="subsubsub_section <?php echo ($this->show_notes) ? "woof_free" : ""; ?>">
...
//lets print our items and taxonomies
                ...
                <section id="tabs-3">
                                ...
                                <div class="select-wrap"> 
                                    <select name="woof_settings[select_design]" class="chosen_select">
                                        <?php foreach ($select_designs as $key => $value) : ?>
                                            <option value="<?php echo $key; ?>" <?php if ($select_design == $key): ?>selected="selected"<?php endif; ?>><?php echo $value; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                    ...
                    <div class="woof-control-section">
                        ...
                        <h4><?php esc_html_e('Image for autoform toggle', 'woocommerce-products-filter') ?></h4>

                        <div class="woof-control-container">
                            <div class="woof-control">
                                <?php
                                if (!isset($woof_settings['autoform_toggle_closed_image'])) {
                                    $woof_settings['autoform_toggle_closed_image'] = '';
                                }
                                ?>
                                <input type="text" name="woof_settings[autoform_toggle_closed_image]" value="<?php echo(isset($woof_settings['autoform_toggle_closed_image']) ? $woof_settings['autoform_toggle_closed_image'] : '') ?>" />
                                <a href="#" class="woof-button woof_select_image"><?php esc_html_e('Select Image', 'woocommerce-products-filter') ?></a>
                            </div>
                            <div class="woof-description">
                                <p class="description"><?php esc_html_e('Any image for autoform toggle', 'woocommerce-products-filter') ?></p>
                            </div>
                        </div>
                                                ...
                                                <li class="woof_ext_li <?php echo($checked ? 'is_enabled' : 'is_disabled'); ?>">
                                                    ...
                                                    <div class="woof_ext-cell">
                                                        <label for="<?php echo esc_attr($idx) ?>">
                                                            <input type="checkbox" id="<?php echo esc_attr($idx) ?>" <?php if (isset($info['status']) AND $info['status'] == 'premium' AND $this->show_notes): ?>disabled="disabled"<?php endif; ?> <?php if ($checked): ?>checked=""<?php endif; ?> value="<?php echo $idx ?>" name="woof_settings[activated_extensions][]" />
                                                            <?php
                                                    ...
                                                    <div class="woof_ext-cell">
                                                        ...
                                                        if (!empty($info)) {
                                                            ...
                                                            if (!empty($info) AND is_array($info)) {
                                                                ...
                                                                <?php
                                                                echo '<p class="description">' . $info['description'];
                                                                if (isset($info['warning']) && $this->show_notes) {
                                                                    echo " <span class='woof-ext-warning'>" . $info['warning'] . "</span>";
                                                                }
                                                                echo '</p>';
                                                            } else {
                                                                echo $dir;
    ...
    switch ($key) {
        case 'by_price':
            ...
            <li data-key="<?php echo $key ?>" class="woof_options_li">
                ...
                <input type="hidden" name="woof_settings[<?php echo $key ?>][price_slider_skin]" value="<?php echo $woof_settings[$key]['price_slider_skin'] ?>" />
            </li>
            <?php
            break;
