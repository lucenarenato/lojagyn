...
<div class="woof_price_filter_dropdown_container">
	<label class="woof_wcga_label_hide"  for="<?php echo $select_id  ?>"><?php esc_html_e('Filter by price', 'woocommerce-products-filter') ?></label>
    <select id="<?php echo $select_id  ?>" class="woof_price_filter_dropdown">
