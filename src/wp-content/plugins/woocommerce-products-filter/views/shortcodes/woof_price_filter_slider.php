...
if (isset($this->settings['by_price']['show_text_input']) AND $this->settings['by_price']['show_text_input']) {
    ...
    <div class="woof_price_filter_txt_slider">
		<label class="woof_wcga_label_hide"  for="<?php echo $uniqid ?>_from"><?php _e('Price from', 'woocommerce-products-filter') ?></label>
        <input id="<?php echo $uniqid ?>_from" type="number" class="woof_price_filter_txt woof_price_filter_txt_from" placeholder="<?php echo $min ?>" data-value="<?php echo $min ?>" value="<?php echo $min_price ?>" />&nbsp;
        <label class="woof_wcga_label_hide"  for="<?php echo $uniqid ?>_to"><?php _e('Price to', 'woocommerce-products-filter') ?></label>
		<input id="<?php echo $uniqid ?>_to" type="number" class="woof_price_filter_txt woof_price_filter_txt_to" placeholder="<?php echo $max ?>" name="max_price" data-value="<?php echo $max ?>" value="<?php echo $max_price ?>" />
...
<?php } ?>
<label class="woof_wcga_label_hide"  for="<?php echo $uniqid ?>"><?php _e('Price filter', 'woocommerce-products-filter') ?></label>
<input class="woof_range_slider" id="<?php echo $uniqid ?>" data-skin="<?php echo $skin ?>" data-taxes="<?php echo $tax ?>" data-min="<?php echo $min ?>" data-max="<?php echo $max ?>" data-min-now="<?php echo $min_price ?>" data-max-now="<?php echo $max_price ?>" data-step="<?php echo $slider_step ?>" data-slider-prefix="<?php echo $slider_prefix ?>" data-slider-postfix="<?php echo $slider_postfix ?>" value="" />
