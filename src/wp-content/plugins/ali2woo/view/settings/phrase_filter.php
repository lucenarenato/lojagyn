    ...
    (function ($) {
               ...
               var json = $.parseJSON(response);
                    if (json.state === 'error') {
                        ...
                        if (typeof json.review_valuenow !== 'undefined') {
                              ...
                              jQuery('#a2w-panel-info').fadeIn(400);
                              setTimeout(function(){ get_status_filter(true) }, 1000);
                        }
                        else {
      ...
      //  get_status_filter();
        ...
        $(".modal-apply-phrases .btn-group .btn").on("click", function () {
            ...
            if ($(this).val() == 'reviews' || $(this).val() == 'shippings') $(".modal-apply-phrases .scope").hide();
            
            else if ($(this).val() == 'products' || $(this).val() == 'all_types') $(".modal-apply-phrases .scope").show();
