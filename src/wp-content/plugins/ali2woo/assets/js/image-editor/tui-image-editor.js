...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ImageEditor = function () {
	    ...
	    _createClass(ImageEditor, [{
	        ...
	        key: 'undo',
	        value: function undo(oper_id, callback) {
	            return this._invoker.undo(oper_id, callback);
	        }
	        ...
	        value: function loadImageFromURL(url, imageName, operation_id) {
	            if (!imageName || !url) {
	                return Promise.reject(rejectMessages.invalidParameters);
	            }

	            return this.execute(commands.LOAD_IMAGE, imageName, url, operation_id);
	        }
	        ...
	        value: function crop(rect) {
	            ...
	            return this.loadImageFromURL(data.url, data.imageName, 'do_crop');
	        }
	    ...
	    _createClass(Invoker, [{
	        ...
	        value: function undo(oper_id, callback) {
                    ...
                    if (command) {
                        ...
                        var _this_tmp = this;
                        promise = this._invokeUndo(command).then(function () {
                            if(callback){
                                callback(_this_tmp, nextStack);
                            }
                        });
                    } else {
	...
	var Cropper = function (_Component) {
	    ...
	    _createClass(Cropper, [{
	        ...
	        value: function getCroppedImageData(cropRect) {
	            ...
	            var imageData = {
	                imageName: this.getImageName()+"Cropped",
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var command = {
	     ...
	     * @returns {Promise}
	     */
	    execute: function execute(graphics, imageName, imgUrl, operation_id) {
