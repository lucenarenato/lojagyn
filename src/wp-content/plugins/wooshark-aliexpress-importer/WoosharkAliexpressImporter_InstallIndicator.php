...
include_once('WoosharkAliexpressImporter_OptionsManager.php');

class WoosharkAliexpressImporter_InstallIndicator extends WoosharkAliexpressImporter_OptionsManager {
