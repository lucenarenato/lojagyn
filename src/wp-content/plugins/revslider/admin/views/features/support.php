	...
	<!-- START Benefit Support REVOLUTION SLIDER 6.2.50 -->
			<rs-module-wrap id="rev_slider_1030_1_wrapper" data-alias="benefit-support" data-source="gallery" style="background:transparent;padding:0;margin:0px auto;margin-top:0;margin-bottom:0;">
				<rs-module id="rev_slider_1030_1" class="feature_slider" style="" data-version="6.2.50">
					<rs-slides>
						<rs-slide style="position: absolute;" data-key="rs-2091" data-title="Slide" data-in="o:0;" data-out="a:false;">
...
Handheld Customer Support 
								...
								--><rs-layer
									...
									style="z-index:13;"
								><img src="<?php echo RS_PLUGIN_URL;?>admin/views/features/assets/coversupport.jpg" alt="" class="tp-rs-img" width="760" height="428" data-no-retina> 
								</rs-layer><!--

								--><rs-layer
									id="slider-1030-slide-2091-layer-7" 
									class="rs-noevents"
									data-type="text"
								...
								>Get instant solutions to any of your tech woes - no matter how complicated they are 
								</rs-layer><!--
							--></rs-group><!--
-->						</rs-slide>
					</rs-slides>
