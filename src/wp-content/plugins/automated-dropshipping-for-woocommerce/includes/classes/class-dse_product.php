<?php
	...
	class DSE_Product {
		...
		/**
		 * Holds any error that might have occurred.
		 *
		 * @var string $error
		 */
		private $error = '';
		...
		public function __construct( $product ) {
			...
			if ( ! is_array( $product ) ) {
				$this->error = new WP_Error( 'dse_invalid_product', esc_html__( 'The provided data is not a valid product.', 'dropshipexpress' ) );
			}
		...
		/**
		 * Whether the product is valid or WP_Error.
		 *
		 * @return bool
		 */
		...
		/**
		 * Return the possible last error.
		 *
		 * @return string
		 */
