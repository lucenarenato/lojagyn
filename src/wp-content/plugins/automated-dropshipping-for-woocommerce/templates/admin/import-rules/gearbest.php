<?php
	/**
	 * Output the setting tab content for gearbest
	 * api
	 *
	 */ ?>
<div id="dse_import_rule_content_gearbest" class="dse-api-settings-tabs tab-pane fade"  data-rule-api="gearbest" role="tabpanel">
