<?php
	/**
	 * Output the setting tab content for jd
	 * api
	 *
	 */ ?>
<div id="dse_import_rule_content_jingdong" class="dse-api-settings-tabs tab-pane fade"  data-rule-api="jingdong" role="tabpanel">
