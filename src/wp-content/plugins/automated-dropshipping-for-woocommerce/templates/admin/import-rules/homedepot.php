<?php
	/**
	 * Output the setting tab content for Homedepot
	 * api
	 *
	 */ ?>
<div id="dse_import_rule_content_homedepot" class="dse-api-settings-tabs tab-pane fade"  data-rule-api="vip" role="tabpanel">
