<?php
	/**
	 * Output the setting tab content for amazon
	 * api
	 *
	 */ ?>
<div id="dse_import_rule_content_amazon" class="dse-api-settings-tabs tab-pane fade" data-rule-api="amazon" role="tabpanel">
