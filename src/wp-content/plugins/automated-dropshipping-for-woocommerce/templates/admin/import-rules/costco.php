<?php
	/**
	 * Output the setting tab content for costco
	 * api
	 *
	 */ ?>
<div id="dse_import_rule_content_costco" class="dse-api-settings-tabs tab-pane fade"  data-rule-api="vip" role="tabpanel">
