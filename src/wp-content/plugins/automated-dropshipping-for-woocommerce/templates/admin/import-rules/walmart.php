<?php
	/**
	 * Output the setting tab content for Walmart
	 * api
	 *
	 */ ?>
<div id="dse_import_rule_content_walmart" class="dse-api-settings-tabs tab-pane fade"  data-rule-api="vip" role="tabpanel">
