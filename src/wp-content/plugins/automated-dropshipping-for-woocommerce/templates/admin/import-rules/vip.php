<?php
	/**
	 * Output the setting tab content for vip.com
	 * api
	 *
	 */ ?>
<div id="dse_import_rule_content_vip" class="dse-api-settings-tabs tab-pane fade"  data-rule-api="vip" role="tabpanel">
