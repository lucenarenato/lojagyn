...
Dropshipping has never been easier. Automate every task and focus on improving your store instead. Our plugin will allow you to automatically/manually import, publish, edit, sell and ship products from retailers such as AliExpress on your eCommerce store, just by a few clicks.
...
* Automatically ship orders – Set up a ZincAPI account to immediately ship the purchased items to the customers, even when you’re at sleep.
...
= Support =
We provide online documentation and knowledgebase at [support.cydbytes.com](https://support.cetusoft.com).
...
Users on free version can open a ticket on the plugin's page, at wordpress.org. Upgraded members can contact the team via our website for priority support.
= How to access every feature? =
Please visit our [online documentation](https://support.cetusoft.com) for more information.
