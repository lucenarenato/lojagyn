...
$et_row_padding = $et_row_padding ? 'no-padding' : ''; 
$et_full_width = $et_full_width ? 'sec_row container-fluid' : 'sec_row container';
...
$output .= '<div ' . implode( ' ', $wrapper_id ) . ' class="'.$et_full_width.'">';
