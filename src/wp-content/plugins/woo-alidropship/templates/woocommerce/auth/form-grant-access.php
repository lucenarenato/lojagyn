...
<ul class="wc-auth-permissions">
	<?php
	if ( $app_name === 'WooCommerce AliExpress Dropshipping Extension' ) {
		?>
        <li><?php esc_html_e( 'Import AliExpress products', 'woo-alidropship' ); ?></li>
        <li><?php esc_html_e( 'Get orders data to fulfill AliExpress orders', 'woo-alidropship' ); ?></li>
        <li><?php esc_html_e( 'Sync your WooCommerce orders with AliExpress orders', 'woo-alidropship' ); ?></li>
		<?php
	} else {
...
<div class="wc-auth-logged-in-as">
    ...
    <p>
        ...
        <a href="<?php echo esc_url( $logout_url ); ?>"
           class="wc-auth-logout"><?php esc_html_e( 'Logout', 'woocommerce' ); ?></a>
    </p>
</div>

<p class="wc-auth-actions">
    <a href="<?php echo esc_url( $granted_url ); ?>"
       class="button button-primary wc-auth-approve"><?php esc_html_e( 'Approve', 'woocommerce' ); ?></a>
    <a href="<?php echo esc_url( $return_url ); ?>"
       class="button wc-auth-deny"><?php esc_html_e( 'Deny', 'woocommerce' ); ?></a>
</p>
