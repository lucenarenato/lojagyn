	...
	<section class="shipping-calculator-form" style="display:none;">
		...
		<?php if ( apply_filters( 'woocommerce_shipping_calculator_enable_country', true ) ) : ?>
			<p class="form-row form-row-wide" id="calc_shipping_country_field">
				<label for="calc_shipping_country"><?php esc_html_e( 'Select a country / region&hellip;', 'woocommerce' ); ?></label>
		...
		<p><button type="submit" name="calc_shipping" value="1" class="button outlined"><?php esc_html_e( 'Update', 'woocommerce' ); ?></button></p>
